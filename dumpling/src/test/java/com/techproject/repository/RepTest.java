...
public class RepTest {
    ...
    public void createRequestPositiveTest() {
        Request testRequest = new Request("Viet","Create request repository layer", 600, "Pending", "N/A");
    ...
    public void updateRequestPositiveTest() {
        Request updatedRequest = new Request(20,"VietTest", "Updated request repository layer", 500, "Accepted", "Acceptable Request");
